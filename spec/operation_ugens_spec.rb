...
describe UnaryOpUGen do
  ...
  describe UnaryOpUGen do
    ...
    it 'should accept just one input' do
      -> { UnaryOpUGen.new(:neg, @audio, @demand) }.should raise_error(ArgumentError)
    end
  ...
  describe BinaryOpUGen do
    ...
    it 'should accept exactly two inputs' do
      -> { BinaryOpUGen.new(:+, @audio) }.should raise_error(ArgumentError)
      -> { BinaryOpUGen.new(:+, @audio, @demand, @demand) }.should raise_error(ArgumentError)
    end
