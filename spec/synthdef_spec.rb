...
describe SynthDef, 'instantiation' do
  ...
  describe '#collect_control_names' do
    before do
      @sdef     = SynthDef.new(:name) {}
      @function = mock 'grap_function', arguments: %i[arg1 arg2 arg3]
    end
  ...
  describe '#build_controls' do
    ...
    before do
      @sdef     = SynthDef.new(:name) {}
      @function = mock 'grap_function', arguments: %i[arg1 arg2 arg3 arg4]
...
describe 'encoding' do
  ...
  describe 'sending' do
    ...
    it 'should not accept non servers' do
      -> { @sdef.send [1, 2] }.should raise_error(NoMethodError)
      -> { @sdef.send 1, 2 }.should   raise_error(NoMethodError)
    end
