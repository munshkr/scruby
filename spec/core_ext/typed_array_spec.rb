...
describe TypedArray do
  ...
  it 'should raise error if wrong type' do
    -> { TypedArray.new(Type, 1) }.should raise_error(TypeError)
  end
  ...
  it '+ failure' do
    -> { TypedArray.new(Type, Type.new) + [1] }.should raise_error(TypeError)
  end
  ...
  it 'concat failure' do
    -> { TypedArray.new(Type, Type.new).concat(1) }.should raise_error(TypeError)
    -> { TypedArray.new(Type, Type.new).concat([1]) }.should raise_error(TypeError)
  end
  ...
  it '[]= failure' do
    -> { TypedArray.new(Type, Type.new)[0] = 1 }.should raise_error(TypeError)
  end
  ...
  it 'push failure' do
    -> { TypedArray.new(Type, Type.new).push(1) }.should raise_error(TypeError)
  end
